...
//global edits
unsafe extern "C" fn captain_dash(fighter: &mut L2CAgentBase) {
...
unsafe extern "C" fn captain_turndash(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn captain_attack11(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn captain_attack12(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn captain_attacks4(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn captain_attackhi4(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
//aerials
unsafe extern "C" fn captain_attackairf(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn captain_escapeairslide(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
