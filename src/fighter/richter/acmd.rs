...
unsafe extern "C" fn attacklw32(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
pub fn install(agent: &mut smashline::Agent) {
    ...
    agent.game_acmd("game_attacklw32", attacklw32, Priority::Low);
