...
pub fn install(agent: &mut smashline::Agent) {
    ...
    .game_acmd("game_turndash", bayo_turndash)
    
    .game_acmd("game_attack11", bayo_jab1)
    .game_acmd("game_attack12", bayo_jab2)
    .game_acmd("game_attack13", bayo_jab3)
    .game_acmd("game_attack100end", bayo_jab100end)
    .game_acmd("game_attackhi3", bayo_attackhi3)
    .game_acmd("game_attacks3", bayo_attacks3)
    .game_acmd("game_attacks3s2", bayo_attacks3s2)
    .game_acmd("game_attacklw3", bayo_attacklw3)
    .game_acmd("game_attackdash", bayo_attackdash)
    
    .game_acmd("game_attackairhi", bayo_airhi)
    .game_acmd("game_attackairhihold", bayo_airhihold)
    .game_acmd("game_attackairf", bayo_attackairf)
    .game_acmd("game_attackairf2", bayo_attackairf2)
    .game_acmd("game_attackairf3", bayo_attackairf3)
    .game_acmd("game_attackairn", bayo_attackairn)
    .game_acmd("game_attackairb", bayo_attackairb)
    .game_acmd("game_attackairlw", bayo_attackairlw)
    .game_acmd("game_landingairlw", bayo_landingairlw)
    
    .game_acmd("game_catch", bayo_catch)
    .game_acmd("game_catchdash", bayo_catchdash)
    .game_acmd("game_catchturn", bayo_catchturn)
    .game_acmd("game_throwf", bayo_throwf)
    
    .game_acmd("game_escapeb", bayo_escapeb)
    .game_acmd("game_escapen", bayo_escapen)
    .game_acmd("game_escapef", bayo_escapef)
    .game_acmd("game_escapeair", bayo_escapeair)
    .game_acmd("game_escapeairslide", bayo_escapeairslide)
    .install();
}