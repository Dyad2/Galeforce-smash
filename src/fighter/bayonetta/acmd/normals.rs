...
pub fn install(agent: &mut smashline::Agent) {
    agent.game_acmd("game_dash", bayo_dash, Priority::Low)
    .game_acmd("game_turndash", bayo_turndash, Priority::Low)
    
    .game_acmd("game_attack11", bayo_jab1, Priority::Low)
    .game_acmd("game_attack12", bayo_jab2, Priority::Low)
    .game_acmd("game_attack13", bayo_jab3, Priority::Low)
    .game_acmd("game_attack100end", bayo_jab100end, Priority::Low)
    .game_acmd("game_attackhi3", bayo_attackhi3, Priority::Low)
    .game_acmd("game_attacks3", bayo_attacks3, Priority::Low)
    .game_acmd("game_attacks3s2", bayo_attacks3s2, Priority::Low)
    .game_acmd("game_attacklw3", bayo_attacklw3, Priority::Low)
    .game_acmd("game_attackdash", bayo_attackdash, Priority::Low)
    
    .game_acmd("game_attackairhi", bayo_airhi, Priority::Low)
    .game_acmd("game_attackairhihold", bayo_airhihold, Priority::Low)
    .game_acmd("game_attackairf", bayo_attackairf, Priority::Low)
    .game_acmd("game_attackairf2", bayo_attackairf2, Priority::Low)
    .game_acmd("game_attackairf3", bayo_attackairf3, Priority::Low)
    .game_acmd("game_attackairn", bayo_attackairn, Priority::Low)
    .game_acmd("game_attackairb", bayo_attackairb, Priority::Low)
    .game_acmd("game_attackairlw", bayo_attackairlw, Priority::Low)
    .game_acmd("game_landingairlw", bayo_landingairlw, Priority::Low)
    
    .game_acmd("game_catch", bayo_catch, Priority::Low)
    .game_acmd("game_catchdash", bayo_catchdash, Priority::Low)
    .game_acmd("game_catchturn", bayo_catchturn, Priority::Low)
    .game_acmd("game_throwf", bayo_throwf, Priority::Low)
    
    .game_acmd("game_escapeb", bayo_escapeb, Priority::Low)
    .game_acmd("game_escapen", bayo_escapen, Priority::Low)
    .game_acmd("game_escapef", bayo_escapef, Priority::Low)
    .game_acmd("game_escapeair", bayo_escapeair, Priority::Low)
    .game_acmd("game_escapeairslide", bayo_escapeairslide, Priority::Low)
    .install();
}