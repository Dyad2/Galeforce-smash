...
unsafe extern "C" fn bayo_specialhi(fighter: &mut L2CAgentBase) {
...
unsafe extern "C" fn bayo_specialairsu(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn bayo_specialairsd(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn bayo_specialsholdend(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn bayo_specialairsdlanding(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn bayo_speciallw(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn bayo_specialairlw(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
