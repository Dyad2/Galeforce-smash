...
unsafe extern "C" fn bayo_attackhi4wwa(weapon: &mut L2CAgentBase) {
...
unsafe extern "C" fn bayo_attacks4hiwwa(weapon: &mut L2CAgentBase) {
    let lua_state = weapon.lua_state_agent;
...
unsafe extern "C" fn bayo_attacks4wwa(weapon: &mut L2CAgentBase) {
    let lua_state = weapon.lua_state_agent;
...
unsafe extern "C" fn bayo_attacks4lwwwa(weapon: &mut L2CAgentBase) {
    let lua_state = weapon.lua_state_agent;
...
unsafe extern "C" fn bayo_attacklw4wwl(weapon: &mut L2CAgentBase) {
    let lua_state = weapon.lua_state_agent;
