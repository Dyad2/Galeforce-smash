...
//global edits
unsafe extern "C" fn cloud_dash(fighter: &mut L2CAgentBase) {
...
unsafe extern "C" fn cloud_turndash(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn cloud_attacks4(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
//air
unsafe extern "C" fn cloud_attackairn(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn cloud_attackairhi(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
//others
unsafe extern "C" fn cloud_escapeairslide(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
