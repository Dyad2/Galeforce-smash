...
unsafe extern "C" fn buddy_dash(fighter: &mut L2CAgentBase) {
...
unsafe extern "C" fn buddy_turndash(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
//ground
unsafe extern "C" fn buddy_attack100end(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn buddy_attackhi3(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
//air
unsafe extern "C" fn buddy_attackairhi(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn buddy_attackairn(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn buddy_attackairlw(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
//grabs
unsafe extern "C" fn buddy_throwlw(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn buddy_throwb(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
unsafe extern "C" fn buddy_escapeairslide(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
...
pub fn install(agent: &mut smashline::Agent) {
    agent.game_acmd("game_dash", buddy_dash, Priority::Low);
    agent.game_acmd("game_turndash", buddy_turndash, Priority::Low);
    agent.game_acmd("game_attack100end", buddy_attack100end, Priority::Low);
    agent.game_acmd("game_attackhi3", buddy_attackhi3, Priority::Low);
    agent.game_acmd("game_attackairhi", buddy_attackairhi, Priority::Low);
    agent.game_acmd("game_attackairn", buddy_attackairn, Priority::Low);
    agent.game_acmd("game_attackairlw", buddy_attackairlw, Priority::Low);
    agent.game_acmd("game_throwb", buddy_throwb, Priority::Low);
    agent.game_acmd("game_throwlw", buddy_throwlw, Priority::Low);
    agent.game_acmd("game_escapeairslide", buddy_escapeairslide, Priority::Low);
}