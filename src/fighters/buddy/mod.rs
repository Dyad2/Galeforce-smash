...
fn buddy_frame(fighter: &mut L2CFighterCommon) {
    unsafe {
        ...
        if MotionModule::motion_kind(boma) == hash40("attack_air_n") {
            if MotionModule::frame(boma) >= 35.0 && AttackModule::is_infliction_status(boma, *COLLISION_KIND_MASK_HIT)  {
                FIGHTER_GLOBALS[entry_id as usize].banjump = true;
            }
            if FIGHTER_GLOBALS[entry_id as usize].banjump && ((ControlModule::is_enable_flick_jump(boma) && (cat1 & *FIGHTER_PAD_CMD_CAT1_FLAG_JUMP) != 0) || (cat1 & *FIGHTER_PAD_CMD_CAT1_FLAG_JUMP_BUTTON) != 0) && !StopModule::is_stop(boma) && FIGHTER_GLOBALS[entry_id as usize].once {
                ...
                KineticModule::add_speed(boma, &banjump_speed);
                FIGHTER_GLOBALS[entry_id as usize].banjump = false;
        ...
        if StatusModule::situation_kind(boma) == *SITUATION_KIND_GROUND || StatusModule::status_kind(boma) == *FIGHTER_STATUS_KIND_CLIFF_CATCH {
    ...
    if macros::is_excute(fighter)
        {
            ...
            macros::ATTACK(fighter, 0,  0, Hash40::new("top"), 1.0, 48, 100, 60, 0, 4.3, 0.0, 4.5, -5.1, None, None, None, 0.5, 0.8, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 3, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("*COLLISION_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_PUNCH);
            macros::ATTACK(fighter, 1,  0, Hash40::new("top"), 1.0, 335, 100, 40, 0, 4.3, 0.0, 15.0, -5.1, None, None, None, 0.5, 0.8, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 3, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("*COLLISION_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_PUNCH);
            macros::ATTACK(fighter, 2,  0, Hash40::new("top"), 1.0, 220, 100, 40, 0, 4.3, 0.0, 15.0, 6.1, None, None, None, 0.5, 0.8, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 3, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("*COLLISION_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_PUNCH);
            macros::ATTACK(fighter, 3,  0, Hash40::new("top"), 1.0, 140, 100, 40, 0, 4.3, 0.0, 15.0, 6.1, None, None, None, 0.5, 0.8, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 3, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("*COLLISION_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_PUNCH);
            macros::ATTACK(fighter, 4,  0, Hash40::new("top"), 1.0, 130, 100, 75, 0, 4.3, 0.0, 4.5, 6.1, None, None, None, 0.5, 0.8, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 3, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("*COLLISION_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_PUNCH);
        }
    frame(lua_state, 30.0);
        if macros::is_excute(fighter)
            {
    ...
    if macros::is_excute(fighter)
        {
            ...
            FighterCutInManager::set_throw_finish_offset(fighter_cutin_manager, Vector3f{x: 8., y: 0., z: 0.});
        }
