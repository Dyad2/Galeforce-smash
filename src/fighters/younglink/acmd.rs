...
pub fn install(agent: &mut smashline::Agent) {
    ...
    agent.game_acmd("game_aircatch", aircatch,);
    agent.game_acmd("game_aircatchmove", aircatchmove,);
    agent.game_acmd("game_appeallwl", lonlonheal,);
    agent.game_acmd("game_appeallwr", lonlonheal,);
