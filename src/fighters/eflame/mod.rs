...
//global edits
#[acmd_script( agent = "eflame", script = "game_dash", category = ACMD_GAME, low_priority)]
...
#[acmd_script( agent = "eflame", script = "game_turndash", category = ACMD_GAME, low_priority)]
