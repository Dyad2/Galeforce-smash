...
unsafe fn jab1(fighter: &mut L2CAgentBase) {
    ...
    frame(lua_state, 9.);
        if macros::is_excute(fighter)
        {
            ...
            AttackModule::set_shield_stiff_mul(fighter.module_accessor, 0.5); //makes it less likely to push fighters down platforms
        }
...
unsafe fn airf(fighter: &mut L2CAgentBase) {
    ...
    frame(lua_state, 29.);
        if macros::is_excute(fighter)
        {
            //MotionModule::set_rate(fighter.module_accessor, 1.4) //try to set FAF at 35
            WorkModule::off_flag(fighter.module_accessor, *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
        }
}
...
unsafe fn specialhi(fighter: &mut L2CAgentBase) {
    ...
    frame(lua_state, 30.);
        if macros::is_excute(fighter) {
            ...
            {
                if VarModule::is_flag(fighter.battle_object, bayonetta::status::flag::SPECIAL_HI_SHOOT) { //bullet arts
                    macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 3.5, 3, 50, 0, 400, 7.5, 0.0, 26.5, 0.5, Some(0.0), Some(10.0), Some(0.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false,Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PUNCH);
                    AttackModule::set_add_reaction_frame_revised(fighter.module_accessor, 0, 1.0, false);
                }
                else {
...
unsafe fn specialairhi(fighter: &mut L2CAgentBase) {
    ...
    frame(lua_state, 30.);
        if macros::is_excute(fighter) {
            ...
            {
                if VarModule::is_flag(fighter.battle_object, bayonetta::status::flag::SPECIAL_HI_SHOOT) { //bullet arts
                    macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 3.5, 32, 60, 0, 50, 7.5, 0.0, 26.5, 0.5, Some(0.0), Some(10.0), Some(0.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false,Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PUNCH);
            ...
            {
                if VarModule::is_flag(fighter.battle_object, bayonetta::status::flag::SPECIAL_HI_SHOOT) { //bullet arts
                    macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 3.5, 20, 60, 0, 50, 7.5, 0.0, 26.5, 0.5, Some(0.0), Some(10.0), Some(0.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false,Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PUNCH);
                    AttackModule::set_add_reaction_frame_revised(fighter.module_accessor, 0, 3.0, false);
                }
                else {
                    macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 3.0, 3, 50, 0, 30, 7.5, 0.0, 26.5, 0.5, Some(0.0), Some(10.0), Some(0.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false,Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PUNCH);
